...
const translations = {
  pt: {
    ...
    indisponivelMsg: "Esta peça não está disponível de momento.",
  ...
  fr: {
    ...
    indisponivelMsg: "Cette pièce n'est pas disponible pour le moment.",
  ...
  lt: {
    ...
    indisponivelMsg: "Šis drabužis šiuo metu neprieinamas.",
    selecioneTamanho: "Pasirinkite dydį",
  },
};
...
const pecaExemplo = {
  ...
  categoria: "Vestidos",
  descricao: "Um vestido elegante em seda natural, com corte fluido que acompanha o corpo. Ideal para jantares de gala, cerimónias e eventos especiais. O acabamento em cetim confere um brilho subtil e sofisticado.",
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        :root { --black: #080808; --white: #f8f7f5; --grey-100: #f0eeeb; --grey-200: #e2dfda; --grey-400: #888580; --grey-600: #4a4845; --serif: 'Cormorant', Georgia, serif; --sans: 'Jost', Arial, sans-serif; }
        ...
        .pd-nav-logo { font-family:var(--serif); font-size:1.2rem; font-weight:300; letter-spacing:0.25em; text-transform:uppercase; text-decoration:none; color:var(--black); }
        .pd-nav-back { font-size:0.62rem; letter-spacing:0.15em; text-transform:uppercase; color:var(--grey-400); text-decoration:none; font-weight:400; transition:color 0.2s; }
        ...
        .pd-foto-principal { flex:1; overflow:hidden; background:var(--grey-100); }
        ...
        .pd-categoria { font-size:0.58rem; letter-spacing:0.3em; text-transform:uppercase; color:var(--grey-400); font-weight:400; }
        .pd-nome { font-family:var(--serif); font-size:clamp(2rem,3vw,3rem); font-weight:300; line-height:1.05; }
        .pd-preco-wrap { display:flex; align-items:baseline; gap:0.5rem; }
        .pd-preco { font-family:var(--serif); font-size:2.5rem; font-weight:300; }
        .pd-preco-dia { font-size:0.72rem; color:var(--grey-400); letter-spacing:0.1em; font-weight:400; }
        .pd-estado { display:inline-flex; align-items:center; gap:0.4rem; font-size:0.6rem; letter-spacing:0.2em; text-transform:uppercase; font-weight:400; }
        ...
        .pd-tamanhos-label { font-size:0.62rem; letter-spacing:0.2em; text-transform:uppercase; color:var(--grey-400); margin-bottom:0.75rem; font-weight:400; }
        .pd-tamanhos { display:flex; gap:0.5rem; flex-wrap:wrap; }
        .pd-tamanho-btn { width:52px; height:52px; display:flex; align-items:center; justify-content:center; border:1px solid var(--grey-200); background:var(--white); font-size:0.72rem; letter-spacing:0.1em; cursor:pointer; font-family:var(--sans); font-weight:400; transition:all 0.2s; color:var(--black); }
        ...
        .pd-btn-alugar { display:block; width:100%; padding:1.1rem; background:var(--black); color:var(--white); border:none; font-size:0.65rem; letter-spacing:0.2em; text-transform:uppercase; font-family:var(--sans); font-weight:400; cursor:pointer; transition:background 0.2s; text-align:center; text-decoration:none; }
        ...
        .pd-btn-comprar { display:block; width:100%; padding:1rem; background:var(--white); color:var(--black); border:1px solid var(--black); font-size:0.65rem; letter-spacing:0.2em; text-transform:uppercase; font-family:var(--sans); font-weight:400; cursor:pointer; transition:all 0.2s; text-align:center; text-decoration:none; }
        .pd-btn-comprar:hover { background:var(--grey-100); }

        .pd-descricao-titulo { font-size:0.62rem; letter-spacing:0.2em; text-transform:uppercase; color:var(--grey-400); margin-bottom:0.75rem; font-weight:400; }
        .pd-descricao { font-size:0.92rem; color:var(--grey-600); line-height:1.9; font-weight:400; }

        .pd-detalhes { display:flex; flex-direction:column; gap:0.5rem; }
        .pd-detalhe { display:flex; justify-content:space-between; font-size:0.82rem; padding:0.6rem 0; border-bottom:1px solid var(--grey-100); }
        ...
        .pd-btn-partilhar { display:flex; align-items:center; gap:0.5rem; font-size:0.62rem; letter-spacing:0.15em; text-transform:uppercase; color:var(--grey-400); background:none; border:none; cursor:pointer; font-family:var(--sans); font-weight:400; transition:color 0.2s; padding:0; }
        ...
        .pd-partilhar-item { display:flex; align-items:center; gap:0.75rem; padding:0.6rem 0.75rem; font-size:0.75rem; text-decoration:none; color:var(--black); transition:background 0.15s; font-weight:400; }
        .pd-partilhar-item:hover { background:var(--grey-100); }
        .pd-partilhar-dot { width:8px; height:8px; border-radius:50%; flex-shrink:0; }

        .pd-colecao { display:flex; align-items:center; gap:0.5rem; font-size:0.62rem; letter-spacing:0.15em; text-transform:uppercase; color:var(--grey-400); text-decoration:none; transition:color 0.2s; font-weight:400; }
        ...
        .pd-custo { display:flex; justify-content:space-between; font-size:0.78rem; font-weight:400; }
        .pd-custo-key { color:var(--grey-600); }
        .pd-custo-val { color:var(--black); }

        @media (max-width:900px) {
          .pd-nav { padding:1rem 1.5rem; }
          .pd-page { grid-template-columns:1fr; }
          .pd-galeria { position:static; height:auto; }
          .pd-foto-principal { height:70vw; }
      ...
      <div className="pd-page">
        ...
        <div className="pd-info">
          ...
          >
            {peca.estado === 'disponivel' ? t.alugar : t.indisponivelMsg}
          </a>

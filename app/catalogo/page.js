...
const translations = {
  pt: { titulo: "Catálogo", subtitulo: "Roupa e acessórios para cada momento.", todas: "Todas", semResultados: "Nenhuma peça encontrada.", loading: "A carregar...", categorias: ["Vestidos", "Casacos", "Conjuntos", "Acessórios", "Calçado", "Novidades"], recentes: "Mais recentes", precoAsc: "Preço: menor primeiro", precoDesc: "Preço: maior primeiro" },
  fr: { titulo: "Catalogue", subtitulo: "Vêtements et accessoires pour chaque moment.", todas: "Tout", semResultados: "Aucune pièce trouvée.", loading: "Chargement...", categorias: ["Robes", "Manteaux", "Ensembles", "Accessoires", "Chaussures", "Nouveautés"], recentes: "Plus récents", precoAsc: "Prix: croissant", precoDesc: "Prix: décroissant" },
  lt: { titulo: "Katalogas", subtitulo: "Drabužiai ir aksesuarai kiekvienai progai.", todas: "Visi", semResultados: "Drabužių nerasta.", loading: "Kraunama...", categorias: ["Suknelės", "Paltai", "Komplektai", "Aksesuarai", "Avalynė", "Naujienos"], recentes: "Naujausi", precoAsc: "Kaina: mažiausia pirma", precoDesc: "Kaina: didžiausia pirma" },
};

const pecasExemplo = [
  { id: "1", nome: "Vestido Seda Noite", categoria: "Vestidos", preco_aluguer_dia: 35, estado: "disponivel", tamanhos: ["XS", "S", "M"], fotos: ["https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=400&q=80", "https://images.unsplash.com/photo-1568252542512-9fe8fe9c87bb?w=400&q=80"] },
  ...
  { id: "4", nome: "Vestido Midi Floral", categoria: "Vestidos", preco_aluguer_dia: 25, estado: "indisponivel", tamanhos: ["M", "L"], data_fim: new Date(Date.now() + 2 * 24 * 60 * 60 * 1000).toISOString(), fotos: ["https://images.unsplash.com/photo-1495385794356-15371f348c31?w=400&q=80"] },
  { id: "5", nome: "Blazer Alfaiataria", categoria: "Conjuntos", preco_aluguer_dia: 30, estado: "indisponivel", tamanhos: ["S", "M"], data_fim: new Date(Date.now() + 5 * 60 * 60 * 1000).toISOString(), fotos: ["https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=400&q=80"] },
...
export default function Catalogo() {
  ...
  const carregarPecas = async () => {
    setLoading(true);
    const { data } = await supabase.from("pecas").select(`*, stock_tamanhos(tamanho, quantidade_disponivel), categorias(nome)`);
